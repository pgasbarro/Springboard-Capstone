---
title: 'Gasbarro - Clustering - Exercise 7.3'
output:
  pdf_document:
    toc: yes
  html_document:
...
```{r, 0.0, echo=TRUE, warning=FALSE, error=FALSE, message=FALSE}
...
```{r, 1.0, echo=TRUE, warning=FALSE, error=FALSE, message=FALSE}
...
```{r, 4.0, echo=TRUE, warning=FALSE, error=FALSE, message=FALSE}
...
```{r, 5.0, echo=TRUE, warning=FALSE, error=FALSE, message=FALSE}
...
```{r, 0, echo=TRUE, warning=FALSE, error=FALSE, message=FALSE}
library(cluster)

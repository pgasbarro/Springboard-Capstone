...
**QUESTION**: *Why does the previous bar chart show a spike from 2016 to 2017, but the current chart shows steady decline from 2016 to 2017?*
...
The first chart shows the SUM amount of money, across all deals, tracked over time by business sector. All industries saw a decline in the total amount of Expected Revenue from 2016 to 2018, though the decline was modest.

The second chart shows the MEAN amount of money per deal, tracked over time by business sector. Again, all sectors saw a decline in the MEAN amount per deal, but the Energy sector saw the most precipitous drop from 2016 to 2018 among all the sectors.
...
**4. QUESTION: This is the question from one of the previous sections: If the COUNT of WON deals rose from 2016 to 2017, as reflected in the BAR charts, then why do the LINE charts (tracked over time broken down by quarter) show a steady decline from 2016 to 2017?** I haven't been able to address this question.

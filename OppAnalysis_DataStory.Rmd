...
opps_revised2 <- opps_revised %>% 
  mutate(close_year=year(close_date), close_month=month(close_date), combo_date=paste(close_year, close_month, sep="_"), combo_qtr=paste(close_year, fiscal_quarter, sep="_"))
